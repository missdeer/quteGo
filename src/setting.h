...
struct Engine
{
    ...
    Engine(const QString &t, const QString &p, const QString &a, const QString &k, bool an, const QString &size)
...
struct Host
{
    ...
    Host(const QString &t, const QString &h, const unsigned int p, const QString &l, const QString &pw, const QString &c)
