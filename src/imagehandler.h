...
public:
    ...
    void set_stone_params(double         w_hard,
                          double         b_hard,
                          double         w_spec,
                          double         b_spec,
                          double         w_radius,
                          ...
                          int            look,
                          bool           clamshell,
                          const QString &whiteStonePicturePath,
                          const QString &blackStonePicturePath,
                          int            sizePercent)
    {
        m_w_hard                = w_hard;
        m_b_hard                = b_hard;
...
private:
    ...
    void paint_white_stone_picture(QImage &img, int size, int idx);
    void paint_black_stone_picture(QImage &img, int size, int idx);
    void paint_stone_picture(QImage &img, int size, int idx, const QString &path);
